...
var s4tOpenEow = (function() {
    ...
    return function() {
        ...
        header.find('.s4t-feature-title').append(s4tFeatureHelp("EOW Update", "Create a member’s weekly Slack update.", "• Current or previous week\n• Member and Exclude lists selection\n• Editable title, dates and categories\n• Add tasks and drag to reorder\n• Category / task points\n• Editable Slack preview and copy", "Current board only. Cards match the week by due date, activity, creation or dated comments. Drafts save locally.", "Choose a member and week, review tasks and categories, edit the preview, then copy it."));
